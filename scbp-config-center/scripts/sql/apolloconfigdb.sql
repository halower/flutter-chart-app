...
INSERT INTO `ServerConfig` VALUES (1,'eureka.service.url','default','http://127.0.0.1:1111/eureka/','Eureka服务Url，多个service以英文逗号分隔 http://130.75.131.236:1111/eureka/  http://192.168.3.151:1111/eureka/',b'0','default','2018-04-03 23:19:15','','2018-04-03 19:54:12'),(2,'namespace.lock.switch','default','false','一次发布只能有一个人修改开关',b'0','default','2018-04-03 23:19:15','','2018-04-03 23:19:15'),(3,'item.value.length.limit','default','20000','item value最大长度限制',b'0','default','2018-04-03 23:19:15','','2018-04-03 23:19:15'),(4,'config-service.cache.enabled','default','false','ConfigService是否开启缓存，开启后能提高性能，但是会增大内存消耗！',b'0','default','2018-04-03 23:19:15','','2018-04-03 23:19:15'),(5,'item.key.length.limit','default','128','item key 最大长度限制',b'0','default','2018-04-03 23:19:15','','2018-04-03 23:19:15');
