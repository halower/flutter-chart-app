...
public class AuthConfiguration {
  ...
  static class CtripAuthAutoConfiguration {
    ...
    public FilterRegistrationBean authenticationFilter() {
      ...
      casFilter.setFilter(filter("com.ctrip.framework.apollo.sso.filters.ApolloAuthenticationFilter"));
    ...
    public FilterRegistrationBean assertionHolder() {
      ...
      assertionHolderFilter.setFilter(filter("com.ctrip.framework.apollo.sso.filters.ApolloAssertionThreadLocalFilter"));
    ...
    private Filter filter(String className) {
      ...
      try {
        ...
        throw new RuntimeException("instance filters fail", e);
      }
